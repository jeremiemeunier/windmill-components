          ...
          {openCalendar && (
            ...
            >
              <div>
                ...
                <div className="jeremiemeunier datePickerClock">
                  <div className="jeremiemeunier datePickerClockHours"></div>
                  <div className="jeremiemeunier datePickerClockMinutes"></div>
                </div>
              </div>
            </motion.div>
          )}
