...
export class ScatterModel implements IGraphModel<DataPoint> {
  data: DataPoint[];
  config: GraphConfig;
...
export const createScatterModel = (data: DataPoint[], config: GraphConfig) =>
  new ScatterModel(data, config);
